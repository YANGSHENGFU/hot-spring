...
public class VarietyDishes implements Parcelable {
    ...
    public VarietyDishes() {
    }

    protected VarietyDishes(Parcel in) {
    ...
    public static final Creator<VarietyDishes> CREATOR = new Creator<VarietyDishes>() {
        @Override
        public VarietyDishes createFromParcel(Parcel in) {
            return new VarietyDishes(in);
        }

        @Override
        public VarietyDishes[] newArray(int size) {
