package com.modulebase.ui.adapter;
...
public class SpinnerPopAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.item_list_open_layout,null);
            viewHolder = new ViewHolder();
            viewHolder.tv_spinner = convertView.findViewById(R.id.pop_cancel);
