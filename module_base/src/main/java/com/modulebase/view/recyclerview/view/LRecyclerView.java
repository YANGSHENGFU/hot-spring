package com.modulebase.view.recyclerview.view;
...
import com.modulebase.view.recyclerview.headandfootview.ArrowRefreshHeader;
import com.modulebase.view.recyclerview.headandfootview.LoadingFooter;
import com.modulebase.view.recyclerview.recinterface.AppBarStateChangeListener;
import com.modulebase.view.recyclerview.recinterface.ILoadMoreFooter;
...
import com.modulebase.view.recyclerview.recinterface.OnNetWorkErrorListener;
...
public class LRecyclerView extends RecyclerView {
    ...
    private boolean mPullRefreshEnabled = true;  //是否允许刷新
    private boolean mLoadMoreEnabled = true;     //加载更多是否允许
    ...
    private void init() {
        ...
        if (mPullRefreshEnabled) {   //允许刷新
            setRefreshHeader(new ArrowRefreshHeader(getContext().getApplicationContext()));
        }

        if (mLoadMoreEnabled) {      //允许加载更多
    ...
    public void refresh() {
        ...
        if (mPullRefreshEnabled && mRefreshListener != null) {
            ...
            mRefreshing = true;
            mFootView.setVisibility(GONE);
            mRefreshListener.onRefresh();  //调用刷新接口
        }
    }
