...
public class AllArrangCleanAdapter extends RecyclerView.Adapter<AllArrangCleanAdapter.ViewHolder> {
    ...
    public AllArrangCleanAdapter(Context context){
        mContext = context ;
        data = new ArrayList<>();
    }
    ...
    @NonNull
    @Override
    public AllArrangCleanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_ready_clean_room_layout , null );
        return new AllArrangCleanAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllArrangCleanAdapter.ViewHolder viewHolder, int i) {
...
//            });
    ...
    public AllArrangCleanAdapter.CheckLisnter checkLisnter ;
    public void setCheckLisnter(AllArrangCleanAdapter.CheckLisnter checkLisnter) {
