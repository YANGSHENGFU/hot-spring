...
public class BaggageFindAdapter extends RecyclerView.Adapter<BaggageFindAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public BaggageFindAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup , int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_recyc_baggage_find_layout , null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BaggageFindAdapter.ViewHolder viewHolder , int i) {
