...
public class AllCleanRoomPressente implements CleanRoundAPI.Pressente {

    private String TAG = "AllCleanRoomPressente";
    ...
    public AllCleanRoomPressente(Context context, CleanRoundAPI.View view) {
        mContext = context ;
        mView = view ;
