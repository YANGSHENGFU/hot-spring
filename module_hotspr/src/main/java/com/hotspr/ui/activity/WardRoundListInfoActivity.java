...
public class WardRoundListInfoActivity extends BaseActivity implements WardRoundTableView.ItemChoiceListeners{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activtiy_ward_round_listinfo_layout);
        findView() ;
        initData() ;
        chekPermission();
    }
